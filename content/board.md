       ...
       <div class="profile-image-container">
        ...
        <div class="profile-details">
          ...
          <p class="profile-title">Vice-President</p>
           ...
           <a href="https://www.uantwerpen.be/en/staff/alie-lassche_29627/" target="_blank" rel="noopener noreferrer" title="Website" class="profile-link">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
          <circle cx="12" cy="12" r="10"></circle>
          <line x1="2" y1="12" x2="22" y2="12"></line>
          <path d="M12 2a15.3 15.3 0 014 10 15.3 15.3 0 01-4 10 15.3 15.3 0 01-4-10 15.3 15.3 0 014-10z"></path>
          ...
          <p class="profile-bio">NWO Rubicon postdoctoral fellow at the Antwerp Center for Digital Humanities and Literary Criticism (ACDC), University of Antwerp. Her research interests center around the use of computational and statistical methods to study how information spreads in an early-modern society.</p>
        </div>
      </div>
      <!-- profile 3 -->
      <div class="profile-card">
       <div class="profile-image-container">
        ...
        <div class="profile-details">
          ...
          <p class="profile-title">Venue Commissioner</p>
      ...
      <div class="profile-card">
       ...
       <div class="profile-image-container">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
          ...
          <p class="profile-bio">Incoming assistant professor in the University of Wisconsin-Madison's Computer Sciences department. Her research focuses on natural language processing of social and cultural data.</p> 
        </div>
      </div>
       ...
       <div class="profile-image-container">
        ...
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
          ...
          <p class="profile-bio">Postdoctoral researcher at the Technical University of Darmstadt working at the intersection of digital humanities and literary studies. Her research focuses on canonisation processes, quantitative literary history, and comparative computational approaches to literature.</p>
        </div>
      </div>
      </div>